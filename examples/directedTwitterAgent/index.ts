...
const logger = createLogger('directed-twitter-agent');
...
const main = async () => {
  ...
  const initialMessage = `As a social media manager, you are expected to interact with twitter periodically in order to maintain social engagement. Run the twitter workflow to handle twitter related tasks.`;
