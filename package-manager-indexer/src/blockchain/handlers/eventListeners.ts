...
export const setupEventListeners = (
  ...
  contract.on(
    toolRegisteredFilter,
    async (
      rawName: any,
      major: ethers.BigNumberish,
      minor: ethers.BigNumberish,
      patch: ethers.BigNumberish,
      cidHash: string,
      publisher: string,
      ...
      try {
        ...
        try {
          ...
          logger.error(`Error extracting data from transaction ${event.transactionHash}:`, error);
        }
      } catch (error) {
