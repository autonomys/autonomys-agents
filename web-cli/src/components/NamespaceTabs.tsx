...
import { Flex, Box, Text, Badge, useToken } from '@chakra-ui/react';
...
const NeuralConnection: React.FC<NeuralConnectionProps> = ({ x1, y1, x2, y2, active, delay = 0 }) => (
  <Box
    position="absolute"
    top="0"
    left="0"
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        right="0"
        height="2px"
        backgroundImage={dataProcessing ? 
          ...
          return (
            ...
            >
              ...
              <Box
                ...
                my={1}
                animation={
                  isPulsing ? "neuronActivate 0.8s ease-out" : 
                  isActive ? "neuralPulse 2s infinite" : "none"
                }
